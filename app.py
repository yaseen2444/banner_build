    ...
    with gr.Tab("Step 1: Generate Promo Images"):
        with gr.Row():
            ...
            deal_prompt = gr.Textbox(
                ...
                lines=3, 
                value="Create a short and eye-catching minimum 10 sentence and simple heading for a sale offer. The offer is Big Basket 53% off in Big Indian Grocery Sale. Give me only the heading with no other text, no ##, ** or any other sign in start and end of text and only one small and good heading in 15 words"
            )
